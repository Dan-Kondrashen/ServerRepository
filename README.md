<h1><b>Краткое описание представленной клиентской части проекта</b></h1>
...
Предпологается, что основными пользователями приложения будут студенты и выпускники университетов активно ищущие работу, а также потенциальные работодатели, которых интересуют подобные кадры. 
...
<h1><b>Основные модули клиентской части приложения</b></h1>
