<h1><b>Краткое описание проекта</b></h1>

В данном проекте представлено приложение, оптимизирующее процесс организации трудоустрйства студентов, разработанное по мобильные устройства с операционной системой на базе <b>Android версии 7 - 14 (api 24 - 34)</b>.
