<h1><b>Клинтская часть проекта мобильного приложения по трудоустройству студентов </b></h1>

Клиентская часть приложения предназначена для оптимизирующего процесса организации трудоустрйства студентов и разработанна под мобильные устройства с операционной системой на базе <b>Android версии 7 - 14 (api 24 - 34)</b>.

В проекте используются такие инструментальные средства, как:
1) Пакет библиотек <b>Android jatpack</b>, для организации эффективной навигации в приложении и асинхронной подгрузки данных с помощью LiveData.
2) <b>MPAndroidChart</b>, для организации построения графиков по собранным статистическим данным.
3) Библиотека <b>Retrofit2</b>, для организации запросов к серверу.
4) <b>Kotlin coroutines</b>, для организации асинхронной подгрузки данныцх с сервера (и использования  launch для подгрузки данных из Room БД).
5) База данных <b>Room</b>, для организации хранения данных и автономной работы пользователя.
6) <b>FCM</b>, для организации отправки <b>PUSH</b> уведомлений и чата в реальном времени.
7) Паттерн проектирования <b>MVVM</b>.
8) <b>Robolectric</b> для организации тестирования запросов к БД <b>Room</b>.
9) <b>Glide</b>, для организации подгрузки фотографий, а также PDF и GIF-файлов.
10) Дополнительные библиотеки, такие как <b>Android PDF Viewer</b> или <b>Searchable Spinner</b>.
11) Язык XML, используемый для разработки представлений.

Пользователи приложения:
1) студенты и выпускники университетов в поиске работы;
2) потенциальные работодатели;
3) администраторы приложения;

<h1><b>Основные модули клиентской части</b></h1>

В приложении реализованы слудующие модули:
1. Модуль аутентификации содержащий страницы регистрации и авторизации.
  <p align="center"> 
    <img src=https://github.com/Dan-Kondrashen/ServerRepository/assets/71755503/271aafe0-a89e-4350-89cc-898ff31a6ccf width="400" />
...
3. Модуль добавления данных, представленный в виде диалоговых окон и фрагмента добавления документов пользователя (вакансий или резюме)
...
<p align="center"> 
     <img src=https://github.com/Dan-Kondrashen/ServerRepository/assets/71755503/dd3f9f0d-a0e1-4520-87c2-056090229ea0 width="242" />
     <img src=https://github.com/Dan-Kondrashen/ServerRepository/assets/71755503/694bf2a7-d85b-45ff-9b10-aa246edf55d7 width="230"/>
</p>

4. Модуль личного кабинета, в котором пользователь может создавать основные документы (вакансии или резюме) или подтверждающие документы (по опыту работы или специальностям пользователя).
...
6. Модуль организации чата по откликам на документы.
...
7. Модуль фильтрации документов.

В этом модуле пользователь может определить фильтры, в соответствии с которыми определяется:
1) количество отображаемых документов;
2) навыки указанные в документах;
3) начальная и конечная дата добавления документов;
4) способ получения списка документов (с начала или конца списка)
<p align="center">
