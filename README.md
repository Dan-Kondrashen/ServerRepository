...
3) потенциальные работодатели;
4) администраторы приложения;
...
В этом модуле пользователь может выбрать такие фильтры как:
1) количество отображаемых документов;
2) навыки указанные в документах;
3) начальную и конечную дату добавления документов;
4) 
<p align="center">
