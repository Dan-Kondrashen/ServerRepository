...
2) MPAndroidChart, для организации построения графиков по собранным статистическим данным.
3) Библиотека Retrofit2, для организации запросов к серверу.
4) Kotlin coroutines, для организации асинхронной подгрузки данныцх с сервера (и использования  launch для подгрузки данных из Room БД).
5) База данных Room, для организации хранения данных и автономной работы пользователя.
6) FCM, для организации отправки PUSH уведомлений и чата в реальном времени.
7) Паттерн проектирования MVVM.
