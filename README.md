...
Предполагается, что основными пользователями приложения будут студенты и выпускники университетов, активно ищущие работу, а также потенциальные работодатели, которых интересуют подобные кадры. 
