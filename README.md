...
В данной ветке представлена клиентская часть приложения, оптимизирующего процесс организации трудоустрйства студентов и разработанного под мобильные устройства с операционной системой на базе <b>Android версии 7 - 14 (api 24 - 34)</b>.

В проекте используются такие инструментальные средства, как:
1) Пакет библиотек <b>Android jatpack</b>, для организации эффективной навигации в приложения и асинхронной подгрузки данных с помощью LiveData.
