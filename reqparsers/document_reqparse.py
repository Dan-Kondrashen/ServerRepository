...
parserFilterFull = reqparse.RequestParser()
parserFilterFull.add_argument('salaryF')
parserFilterFull.add_argument('salaryS')
parserFilterFull.add_argument('dateStart')
parserFilterFull.add_argument('dateEnd')
parserFilterFull.add_argument('orderType')
parserFilterFull.add_argument('numItems')
parserFilterFull.add_argument('knowIdList', location='json', type = list)
